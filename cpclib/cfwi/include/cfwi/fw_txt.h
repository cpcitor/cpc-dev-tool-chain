...
/** #### CFWI-specific information: ####
    ...
    CFWI_TEST_FLAGS: TESTED_APP_PASS
*/
void fw_txt_win_enable(uint8_t left, uint8_t right, uint8_t top, uint8_t bottom) __preserves_regs(iyh, iyl);
 ...
 */
void fw_txt_win_enable__fastcall(uint32_t fw_txt_window_t_asint) __preserves_regs(iyh, iyl) __z88dk_fastcall;
...
/** 42: TXT CUR DISABLE #BB7E
    ...
    TXT UNDRAW CURSOR
*/
void fw_txt_cur_disable(void) __preserves_regs(b, c, d, e, iyh, iyl);
...
fw_txt_character_matrix_t *fw_txt_get_matrix__ignore_rom_indication(uint8_t character_number) __preserves_regs(b, c, d, e, iyh, iyl) __z88dk_fastcall;
