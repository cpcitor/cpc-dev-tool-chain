...
test_open_file_in ()
{
...

	{
		...
		case 1:
			...
			print_uint8_as_hex (file_open_in_params.
					    out_filetype_or_error);
			cfwi_txt_str0_output ("Data location: ");
			print_uint16_as_hex ((uint16_t) file_open_in_params.
					     out_data_location);
...
test_open_file_out ()
{
...

	{
		...
		case 1:
			...
			cfwi_txt_str0_output (NL "Header location: ");
			print_uint16_as_hex ((uint16_t) file_open_out_params.
					     out_header);
			break;
